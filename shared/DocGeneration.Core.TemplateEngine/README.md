# DocGeneration.Core.TemplateEngine

DocGeneration.Core.Shared Handlebars template rendering library used by multiple documentation generator projects. Wraps [Handlebars.Net](https://github.com/Handlebars-Net/Handlebars.Net) with pre-registered custom helpers.

## Usage

```csharp
using DocGeneration.Core.TemplateEngine;

// Render a template file with data
var result = await HandlebarsDocGeneration.Core.TemplateEngine.ProcessTemplateAsync("template.hbs", data);

// Render a template string
var result = HandlebarsDocGeneration.Core.TemplateEngine.ProcessTemplateString("Hello {{name}}", data);
```
...
## Projects using DocGeneration.Core.TemplateEngine

- **DocGeneration.Steps.AnnotationsParametersRaw.Annotations** — annotation and parameter documentation
- **DocGeneration.Steps.HorizontalArticles** — horizontal how-to articles
- **DocGeneration.Steps.ExamplePrompts.Generation** — AI-generated example prompts

# DocGeneration.Steps.Bootstrap.CliAnalyzer Project - Creation Summary
...
├── DocGeneration.Steps.Bootstrap.CliAnalyzer.csproj                     # .NET 9.0 project configuration
...
├── Analyzers/
│   └── DocGeneration.Steps.Bootstrap.CliAnalyzer.cs                    # Core analysis logic (grouping, statistics)
└── Reports/
...
- DocGeneration.Steps.Bootstrap.CliAnalyzer.cs (18 lines)
- ConsoleReporter.cs (366 lines)
- HtmlReporter.cs (278 lines)

### Configuration
- DocGeneration.Steps.Bootstrap.CliAnalyzer.csproj (22 lines)

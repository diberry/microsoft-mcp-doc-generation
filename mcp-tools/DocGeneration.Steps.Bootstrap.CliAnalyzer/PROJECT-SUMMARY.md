...
The **DocGeneration.Steps.Bootstrap.CliAnalyzer** is a .NET 9.0 console application that provides comprehensive visual analysis of the Azure MCP CLI JSON output. It extracts and analyzes tool metadata, including namespaces, tools, parameters (both required and optional), and generates both console reports and beautiful HTML visualizations.

## Project Structure

```
DocGeneration.Steps.Bootstrap.CliAnalyzer/
├── DocGeneration.Steps.Bootstrap.CliAnalyzer.csproj              # Project file (.NET 9.0)
...
├── Analyzers/
│   └── DocGeneration.Steps.Bootstrap.CliAnalyzer.cs             # Core analysis logic (namespace grouping)
└── Reports/
...
### Analysis (`Analyzers/DocGeneration.Steps.Bootstrap.CliAnalyzer.cs`)

...
.DESCRIPTION
    This script generates the commands reference page listing all available tools.
...
.EXAMPLE
    ...
    ./Generate-Commands.ps1 -OutputPath ../generated -CliVersion "2.0.0-beta.17"
#>
...
try {
    Write-Progress "Generate Commands Page"
    ...
    } elseif (Test-Path "mcp-tools/DocGeneration.Steps.AnnotationsParametersRaw.Annotations/DocGeneration.Steps.AnnotationsParametersRaw.Annotations.csproj") {
    ...
    Write-Info ""
    Write-Success "Commands page generation completed"
    Write-Info "Output directory: $outputDir"
    ...
    Write-Error "Commands page generation failed: $_"
    exit 1
}

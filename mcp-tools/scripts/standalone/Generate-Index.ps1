...
.DESCRIPTION
    This script generates the index page for the documentation.
...
.EXAMPLE
    ./Generate-Index.ps1
    ./Generate-Index.ps1 -OutputPath ../generated -CliVersion "2.0.0-beta.17"
#>
...
try {
    Write-Progress "Generate Index Page"
    ...
    Write-Info ""
    Write-Success "Index page generation completed"
    Write-Info "Output directory: $outputDir"
    ...
    Write-Error "Index page generation failed: $_"
    exit 1
}

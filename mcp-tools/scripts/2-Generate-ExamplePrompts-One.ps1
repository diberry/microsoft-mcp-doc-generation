...
try {
    ...
    $generatorProject = Join-Path $mcpToolsDir "DocGeneration.Steps.ExamplePrompts.Generation"
    ...
    if (-not $SkipValidation) {
        ...
        if ($matchingTools.Count -eq 1) {
            $validatorScript = Join-Path $mcpToolsDir "DocGeneration.Steps.ExamplePrompts.Validation/scripts/Validate-ExamplePrompts-RequiredParams.ps1"

...
.DESCRIPTION
    Checks that the .env file exists in mcp-tools directory and contains
...
.EXAMPLE
    ...
    pwsh ./mcp-tools/scripts/validate-env.ps1

.EXAMPLE
    # Warn only (don't fail)
    pwsh ./mcp-tools/scripts/validate-env.ps1 -WarnOnly
#>

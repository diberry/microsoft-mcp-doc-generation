...
public class VerifyOnlyProcessor
{
    ...
    [
        ...
        ("AbbreviationFixer",      AbbreviationFixer.Fix),
        ("SlashVerbFixer",         SlashVerbFixer.Fix),
    ...
    private static string DescribeChange(string processorName, string before, string after)
    {
        ...
        var context = processorName switch
        {
            ...
            "AbbreviationFixer" => " (abbreviations spelled out)",
            "SlashVerbFixer" => " (slashes replaced with or)",

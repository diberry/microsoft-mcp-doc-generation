...
```bash
cd docs-generation
pwsh ./Generate-DocGeneration.Steps.ToolFamilyCleanup.ps1 -InputDir "./generated/multi-page" -OutputDir "./generated/cleaned"
```
...
cd docs-generation
pwsh ./Generate-DocGeneration.Steps.ToolFamilyCleanup.ps1 -InputDir "/tmp/selected-files"
```
...
cd docs-generation
pwsh ./Generate-DocGeneration.Steps.ToolFamilyCleanup.ps1 -InputDir "/tmp/storage-files"
```

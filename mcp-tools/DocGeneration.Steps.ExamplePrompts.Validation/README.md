...
```
DocGeneration.Steps.ExamplePrompts.Validation/
├── Program.cs                           # CLI entry point
├── PromptValidator.cs                   # Core validation logic
├── DocGeneration.Steps.ExamplePrompts.Validation.csproj        # Project file
├── README.md                            # This file
...
cd docs-generation
./DocGeneration.Steps.ExamplePrompts.Validation/scripts/Validate-ExamplePrompts-RequiredParams.ps1 -OutputPath ../generated
```

Or with explicit paths:

```bash
./DocGeneration.Steps.ExamplePrompts.Validation/scripts/Validate-ExamplePrompts-RequiredParams.ps1 `
...
```
DocGeneration.Steps.ExamplePrompts.Validation/
├── DocGeneration.Steps.ExamplePrompts.Validation.csproj   # Project file (references DocGeneration.Core.GenerativeAI)
...
```bash
cd docs-generation
dotnet test DocGeneration.Steps.ExamplePrompts.Validation.Tests/DocGeneration.Steps.ExamplePrompts.Validation.Tests.csproj
```

...
- **DocGeneration.Core.Shared** - Common utilities and models
- **DocGeneration.Core.NaturalLanguage** - Text cleanup and filename sanitization
- **DocGeneration.Core.Shared** - Common utilities (Handlebars.Net dependency removed — not used by this project)

...
## Steps
1. Refine system and user prompts in `mcp-tools/prompts/` to explicitly request deeper Azure service knowledge, realistic scenarios, and best practices for each service.
2. Update the Handlebars template in `mcp-tools/templates/horizontal-article-template.hbs` to better surface AI-generated content, scenarios, and actionable guidance for any service.

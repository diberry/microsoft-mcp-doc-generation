# DocGeneration.Steps.Bootstrap.CliAnalyzer - Project Deliverables
...
- [x] `DocGeneration.Steps.Bootstrap.CliAnalyzer.csproj` - Project configuration (.NET 9.0)
...
- [x] `Analyzers/DocGeneration.Steps.Bootstrap.CliAnalyzer.cs` - Core logic (18 lines)
...
│
├── Analyzers/
│   └── DocGeneration.Steps.Bootstrap.CliAnalyzer.cs                   # Analysis engine
│
├── Reports/
...
| DocGeneration.Steps.Bootstrap.CliAnalyzer.cs | 18 | Analysis logic |
...
The **DocGeneration.Steps.Bootstrap.CliAnalyzer** project is a complete, production-ready .NET 9.0 application that provides comprehensive visual analysis of Azure MCP CLI JSON data. It successfully analyzes 231 tools across 50 namespaces, generating professional console reports and HTML dashboards with detailed parameter analysis.

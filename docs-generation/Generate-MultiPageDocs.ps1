...
try {
    ...
    Write-Info "Using CLI files from: generated/cli/"
    ...
    $versionOutputFile = "generated/cli/cli-version.json"
    
    $filesExist = @(
        (Test-Path $cliOutputFile),
        (Test-Path $namespaceOutputFile),
        (Test-Path $versionOutputFile)

...
try {
    ...
    Write-Info "  • cli-output.json: $cliExists"
    Write-Info "  • cli-namespace.json: $namespaceExists"
    Write-Info "  • cli-version.json: $versionExists"
    ...
    if ($filesExist -ne 3) {
        ...
        Write-Error "  • $cliOutputFile (exists: $cliExists)"
        Write-Error "  • $namespaceOutputFile (exists: $namespaceExists)"
        Write-Error "  • $versionOutputFile (exists: $versionExists)"

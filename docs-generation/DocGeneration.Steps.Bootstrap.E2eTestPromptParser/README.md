...
```csharp
using DocGeneration.Steps.Bootstrap.E2eTestPromptParser;
...
4. **Update the tests** in `DocGeneration.Steps.Bootstrap.E2eTestPromptParser.Tests/TestPromptMarkdownParserTests.cs`:

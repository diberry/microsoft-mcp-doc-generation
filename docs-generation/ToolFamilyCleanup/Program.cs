...
internal class Program
{
    ...
    private static CleanupConfiguration ParseArguments(string[] args)
    {
    ...
    private static void PrintUsage()
    {
        ...
        Console.WriteLine("  -i, --input-dir <path>     Input directory containing tool family markdown files");
        Console.WriteLine("                             Default: ./generated/multi-page");
        Console.WriteLine();
        Console.WriteLine("  -p, --prompts-dir <path>   Directory to save generated prompts");
        Console.WriteLine("                             Default: ./generated/tool-family-cleanup-prompts");
        Console.WriteLine();
        Console.WriteLine("  -o, --output-dir <path>    Directory to save cleaned markdown files");
        Console.WriteLine("                             Default: ./generated/tool-family-cleanup");
        Console.WriteLine();
        ...
        Console.WriteLine("  FOUNDRY_MODEL_NAME         Azure OpenAI deployment/model name");
    }
}

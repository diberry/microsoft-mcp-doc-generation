...
public sealed class BootstrapStep : StepDefinition
{
    ...
    public override async ValueTask<StepResult> ExecuteAsync(PipelineContext context, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                var brandMappingProject = Path.Combine(context.DocsGenerationRoot, "BrandMapperValidator", "BrandMapperValidator.csproj");
            ...
            var e2eProject = Path.Combine(context.DocsGenerationRoot, "E2eTestPromptParser", "E2eTestPromptParser.csproj");
            ...
            var azmcpProject = Path.Combine(context.DocsGenerationRoot, "AzmcpCommandParser", "AzmcpCommandParser.csproj");

...
- Prepared deployment plan: Run the azure-prepare skill first to generate your .azure/deployment-plan.md and infrastructure files. Then run the azure-validate skill to verify readiness.

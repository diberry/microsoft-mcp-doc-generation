...
This tool executes `storagesync service create` via MCP Server.
...
```azurecli
azmcp storagesync service create --resource-group <resource-group> --name <name> --location <location>
```

...
This tool executes `aks nodepool get` via MCP Server.
...
```azurecli
azmcp aks nodepool get --resource-group <resource-group> --cluster <cluster> --nodepool <nodepool>
```
...
| `--nodepool` | string | - | AKS node pool (agent pool) name. |

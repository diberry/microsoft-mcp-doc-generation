...
This tool executes `appservice webapp settings get-appsettings` via MCP Server.
...
```azurecli
azmcp appservice webapp settings get-appsettings --resource-group <resource-group> --app <app>
```

...
This tool executes `storagesync serverendpoint delete` via MCP Server.
...
```azurecli
azmcp storagesync serverendpoint delete --resource-group <resource-group> --name <name> --sync-group-name <sync-group-name> --server-endpoint-name <server-endpoint-name>
```

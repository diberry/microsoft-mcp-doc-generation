...
This tool executes `communication sms send` via MCP Server.
...
```azurecli
azmcp communication sms send --endpoint <endpoint> --from <from> --to <to> --message <message> --enable-delivery-report <enable-delivery-report> --tag <tag>
```

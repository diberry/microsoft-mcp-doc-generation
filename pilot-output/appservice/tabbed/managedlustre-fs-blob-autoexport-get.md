...
This tool executes `managedlustre fs blob autoexport get` via MCP Server.
...
```azurecli
azmcp managedlustre fs blob autoexport get --resource-group <resource-group> --filesystem-name <filesystem-name> --job-name <job-name>
```

...
This tool executes `sql server firewall-rule delete` via MCP Server.
...
```azurecli
azmcp sql server firewall-rule delete --resource-group <resource-group> --server <server> --firewall-rule-name <firewall-rule-name>
```

...
This tool executes `azurebackup job get` via MCP Server.
...
```azurecli
azmcp azurebackup job get --resource-group <resource-group> --vault <vault> --vault-type <vault-type> --job <job>
```

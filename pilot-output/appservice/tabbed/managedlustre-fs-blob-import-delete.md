...
This tool executes `managedlustre fs blob import delete` via MCP Server.
...
```azurecli
azmcp managedlustre fs blob import delete --resource-group <resource-group> --filesystem-name <filesystem-name> --job-name <job-name>
```

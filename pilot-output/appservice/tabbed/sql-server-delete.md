...
This tool executes `sql server delete` via MCP Server.
...
```azurecli
azmcp sql server delete --resource-group <resource-group> --server <server> --force <force>
```
...
| `--force` | string | Force delete the server without confirmation prompts. |

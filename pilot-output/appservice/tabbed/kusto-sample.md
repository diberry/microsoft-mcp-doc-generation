...
This tool executes `kusto sample` via MCP Server.
...
```azurecli
azmcp kusto sample --cluster-uri <cluster-uri> --cluster <cluster> --database <database> --table <table> --limit <limit>
```
...
| `--limit` | string | - | The maximum number of results to return. Must be a positive integer between 1 and 10000. Default is 10. |

...
This tool executes `fileshares fileshare snapshot get` via MCP Server.
...
```azurecli
azmcp fileshares fileshare snapshot get --resource-group <resource-group> --file-share-name <file-share-name> --snapshot-name <snapshot-name>
```

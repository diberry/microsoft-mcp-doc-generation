...
This tool executes `storagesync syncgroup delete` via MCP Server.
...
```azurecli
azmcp storagesync syncgroup delete --resource-group <resource-group> --name <name> --sync-group-name <sync-group-name>
```

...
This tool executes `eventhubs eventhub delete` via MCP Server.
...
```azurecli
azmcp eventhubs eventhub delete --resource-group <resource-group> --namespace <namespace> --eventhub <eventhub>
```

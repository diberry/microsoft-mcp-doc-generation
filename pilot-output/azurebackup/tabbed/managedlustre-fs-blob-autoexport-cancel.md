...
This tool executes `managedlustre fs blob autoexport cancel` via MCP Server.
...
```azurecli
azmcp managedlustre fs blob autoexport cancel --resource-group <resource-group> --filesystem-name <filesystem-name> --job-name <job-name>
```

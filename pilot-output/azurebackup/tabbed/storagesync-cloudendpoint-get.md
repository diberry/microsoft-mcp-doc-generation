...
This tool executes `storagesync cloudendpoint get` via MCP Server.
...
```azurecli
azmcp storagesync cloudendpoint get --resource-group <resource-group> --name <name> --sync-group-name <sync-group-name> --cloud-endpoint-name <cloud-endpoint-name>
```

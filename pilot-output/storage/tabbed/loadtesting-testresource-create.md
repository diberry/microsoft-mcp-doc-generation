...
This tool executes `loadtesting testresource create` via MCP Server.
...
```azurecli
azmcp loadtesting testresource create --test-resource-name <test-resource-name> --resource-group <resource-group>
```

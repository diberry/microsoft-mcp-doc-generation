...
This tool executes `managedlustre fs blob autoimport cancel` via MCP Server.
...
```azurecli
azmcp managedlustre fs blob autoimport cancel --resource-group <resource-group> --filesystem-name <filesystem-name> --job-name <job-name>
```

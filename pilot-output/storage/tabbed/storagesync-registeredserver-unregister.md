...
This tool executes `storagesync registeredserver unregister` via MCP Server.
...
```azurecli
azmcp storagesync registeredserver unregister --resource-group <resource-group> --name <name> --server-id <server-id>
```

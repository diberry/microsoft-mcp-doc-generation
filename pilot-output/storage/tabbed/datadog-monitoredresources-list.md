...
This tool executes `datadog monitoredresources list` via MCP Server.
...
```azurecli
azmcp datadog monitoredresources list --datadog-resource <datadog-resource> --resource-group <resource-group>
```
...
| `--datadog-resource` | string | The name of the Datadog resource to use. This is the unique name you chose for your Datadog resource in Azure. |

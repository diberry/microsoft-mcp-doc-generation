...
This tool executes `virtualdesktop hostpool host user-list` via MCP Server.
...
```azurecli
azmcp virtualdesktop hostpool host user-list --resource-group <resource-group> --hostpool <hostpool> --hostpool-resource-id <hostpool-resource-id> --sessionhost <sessionhost>
```
...
| `--sessionhost` | string | The name of the session host. This is the computer name of the virtual machine in the host pool. |

...
This tool executes `managedlustre fs blob autoimport delete` via MCP Server.
...
```azurecli
azmcp managedlustre fs blob autoimport delete --resource-group <resource-group> --filesystem-name <filesystem-name> --job-name <job-name>
```

...
This tool executes `storagesync registeredserver update` via MCP Server.
...
```azurecli
azmcp storagesync registeredserver update --resource-group <resource-group> --name <name> --server-id <server-id>
```

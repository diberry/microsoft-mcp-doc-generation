...
This tool executes `storagesync serverendpoint get` via MCP Server.
...
```azurecli
azmcp storagesync serverendpoint get --resource-group <resource-group> --name <name> --sync-group-name <sync-group-name> --server-endpoint-name <server-endpoint-name>
```

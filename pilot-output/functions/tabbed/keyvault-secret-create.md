...
This tool executes `keyvault secret create` via MCP Server.
...
```azurecli
azmcp keyvault secret create --vault <vault> --secret <secret> --value <value>
```
...
| `--value` | string | - | The value to set for the secret. |

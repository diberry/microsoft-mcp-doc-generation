...
This tool executes `storagesync syncgroup create` via MCP Server.
...
```azurecli
azmcp storagesync syncgroup create --resource-group <resource-group> --name <name> --sync-group-name <sync-group-name>
```

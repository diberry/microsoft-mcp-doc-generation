...
This tool executes `storagesync cloudendpoint delete` via MCP Server.
...
```azurecli
azmcp storagesync cloudendpoint delete --resource-group <resource-group> --name <name> --sync-group-name <sync-group-name> --cloud-endpoint-name <cloud-endpoint-name>
```

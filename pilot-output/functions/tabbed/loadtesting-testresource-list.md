...
This tool executes `loadtesting testresource list` via MCP Server.
...
```azurecli
azmcp loadtesting testresource list --test-resource-name <test-resource-name> --resource-group <resource-group>
```

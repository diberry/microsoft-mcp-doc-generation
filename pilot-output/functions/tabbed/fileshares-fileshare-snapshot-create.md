...
This tool executes `fileshares fileshare snapshot create` via MCP Server.
...
```azurecli
azmcp fileshares fileshare snapshot create --resource-group <resource-group> --file-share-name <file-share-name> --snapshot-name <snapshot-name> --metadata <metadata>
```

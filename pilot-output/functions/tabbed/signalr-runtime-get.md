...
This tool executes `signalr runtime get` via MCP Server.
...
```azurecli
azmcp signalr runtime get --resource-group <resource-group> --signalr <signalr>
```
...
| `--signalr` | string | - | The name of the SignalR runtime |
